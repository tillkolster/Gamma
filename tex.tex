...
\begin{tikzpicture}
	...
	\addplot[color = red, thin] table {data/Lang_Ge.txt};
	\end{axis}
\end{tikzpicture}
...
\begin{axis}[
		...
		xmin = 28,
		xmax = 35,
		xlabel={Absorptionskante $\si{\kilo \electronvolt}$},
		ylabel={Verhältnis der Peakintegrale},
		]
\addplot[
   only marks, 
   error bars/.cd,
...
table [ x index = {2},y index = {0}, y error index = {1} ] {data/Kanten.txt};
\end{axis}
\end{tikzpicture}
\end{center} 
